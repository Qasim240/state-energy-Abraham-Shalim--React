        ...
        <div className="grid md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-4">
                <div className="bg-gray-flat border border-secondary rounded-large flex flex-col justify-center items-center p-[60px] gap-3 h-[100%]">
                    ...
                    <span className={`${fontMedium} text-base-dark`}>Eytan Ohayon</span>
                    <p className="text-base-dark text-[14px] font-Avenir">eytan@mystateenergy.com</p>
                    <p className="text-base-50 text-[14px] font-Avenir">United States</p>
                </div>
            </div>
